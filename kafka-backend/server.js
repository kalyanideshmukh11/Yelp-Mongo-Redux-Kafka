...
// let CustomerEducation = require('./services/customer-education');
// let CustomerEducationInfo = require('./services/customer-education-info');
// let CustomerExperience = require('./services/customer-experience');
// let CustomerExperienceInfo = require('./services/customer-experience-info');
// let CustomerUpdateEducation = require('./services/customer-update-education');
// let CustomerUpdateExperience = require('./services/customer-update-experience');
// let CustomerDeleteEducation = require('./services/customer-delete-education');
// let CustomerDeleteExperience = require('./services/customer-delete-experience');
// let CustomerSkillsetInfo = require('./services/customer-skillset-info');
// let CustomerSkillset = require('./services/customer-skillset');
...
// handleTopicRequest('customer_education', CustomerEducation);
// handleTopicRequest('customer_education_info', CustomerEducationInfo);
// handleTopicRequest('customer__experience', CustomerExperience);
// handleTopicRequest('customer__experience_info', CustomerExperienceInfo);
// handleTopicRequest('customer_update_education', CustomerUpdateEducation);
// handleTopicRequest('customer_update_experience', CustomerUpdateExperience);
// handleTopicRequest('customer_delete_education', CustomerDeleteEducation);
// handleTopicRequest('customer_delete_experience', CustomerDeleteExperience);
// handleTopicRequest('customer_skillset_info', CustomerSkillsetInfo);
// handleTopicRequest('customer_skillset', CustomerSkillset);
